...
import org.tatzpiteva.golan.Students_ChatMap_Project.View.Communicate;
...
public class LaunchScreenActivity extends FragmentActivity implements
    ...
    private TextView cReq;
    private TextView cUnread;
    private TextView chatcounter;
    private AsyncTaskFriendRequest3 async7;
    private OnResumeOnPause asyncResPau;
    private OnResumeOnPause async;
    private static int countEnterToApp = 0;
...
// QB
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        asyncResPau = new OnResumeOnPause(LaunchScreenActivity.this);
        ...
        cReq = (TextView) findViewById(R.id.cReq);
        chatcounter = (TextView) findViewById(R.id.chatcounter);
        ...
        findViewById(R.id.button_launch_screen_communicatemap).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startcommunicatemapActivity();
            }
        });

        findViewById(R.id.button_launch_screen_communicatechat).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startcommunicatechatActivity();
            }
        });
    ...
    private void startcommunicatemapActivity() {
        startActivity(new Intent(LaunchScreenActivity.this, Communicate.class)
                .setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP));
    }

    private void startcommunicatechatActivity() {
        startActivity(new Intent(LaunchScreenActivity.this, DialogsActivity.class)
                .setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP));
    }
    ...
    public void onStart() {
        ...
        try {
            countEnterToApp++;
            async7 = new AsyncTaskFriendRequest3(LaunchScreenActivity.this);
            async7.execute("http://www.chatmaphannataer.com/index.html/getRequestTable.php?userName=" + getUserNamepref() + "");

            if (countEnterToApp > 1) {
                asyncResPau = new OnResumeOnPause(LaunchScreenActivity.this);
                asyncResPau.execute("http://www.chatmaphannataer.com/index.html/updateUserData.php?userName=" + getUserNamepref() + "&status=" + "ON" + "", "sendData");
            } else {
                async = new OnResumeOnPause(LaunchScreenActivity.this);

                async.execute("http://www.chatmaphannataer.com/index.html/updateWhenLaunchScreenOn.php?userName=" + getUserNamepref() + "&status=" + "ON" + "&whoCanSeeMe=" + null + "&whatIseeOnMap=" + null + "&region=" + null + "&WhoContactMe=" + null + "&location=" + null + "&FakeRealUserName=" + null + "", "sendData");
    ...
    class AsyncTaskFriendRequest3 extends AsyncTask<String, String, Void> {
        ...
        private LaunchScreenActivity ctx;

        public AsyncTaskFriendRequest3(LaunchScreenActivity ctx) {
...
*/
            ...
            if (requestInfoArrayCount2.size() > 0) {
                cReq.setText(String.valueOf(requestInfoArrayCount2.size()));
    ...
    public class OnResumeOnPause extends AsyncTask<String, String, Void> {
        ...
        public OnResumeOnPause(LaunchScreenActivity ctx) {
   ...
   /* QBChatService.markMessagesAsRead("39066", null, new QBEntityCallback<Void>() {
            ...
            QBChatService.getChatDialogs(null, requestBuilder, new QBEntityCallback<ArrayList<QBDialog>>() {
                ...
                public void onSuccess(ArrayList<QBDialog> qbDialogs, Bundle bundle) {
                    ...
                    if (qbDialogs != null && qbDialogs.size() > 0) {
                       ...
                       int a =  dialog.getUnreadMessageCount();
    ...
    public void getSS() {
        ...
        ChatService.getInstance().getDialogs(new QBEntityCallback<ArrayList<QBDialog>>() {
            ...
            public void onSuccess(ArrayList<QBDialog> dialogs, Bundle bundle) {
                ...
                chatcounter.setText(String.valueOf(sum));
