...
public class UserAdapter extends ArrayAdapter<RowItem> {
    ...
    public UserAdapter(Context context, int resource, ArrayList<RowItem> objects) {
        ...
        if(userIconUrl==null){
          //  userIconUrl =  "http://www.clker.com/cliparts/d/L/P/X/z/i/no-image-icon.svg";
        }
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            holder.pic = (ImageView) v.findViewById(R.id.imageView1);

            //Sending friend request
            makeFriend = (Button)v.findViewById(R.id.addBtn) ;
            makeFriend.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    new sendReq().execute("http://www.chatmaphannataer.com/index.html/enterDataToRequestTable.php?userName="+actorList.get(position).getMember_name()+"&userSendR="+getUserNamepref()+"&pic="+userIconUrl+"");
                    Toast.makeText(getApplicationContext(),"Friend Request has been Send to "+actorList.get(position).getMember_name()+"", Toast.LENGTH_SHORT).show();
    ...
    public void LoadUserImg_URLAfterImp(String url,ImageView bmImage) {
       ...
       // userIconUrl = url ;
        if (url != null) {
            ...
            UrlImageViewHelper.setUrlDrawable(bmImage, url, new UrlImageViewCallback() {
