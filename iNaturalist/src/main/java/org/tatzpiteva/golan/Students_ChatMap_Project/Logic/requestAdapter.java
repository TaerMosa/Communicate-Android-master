 ...
 */
public class requestAdapter extends ArrayAdapter<RowItem> {
    ...
    public requestAdapter(Context context, int resource, ArrayList<RowItem> objects) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
       ...
       // this.position = position ;
        ...
        if (v == null) {
            ...
            holder.tvName = (TextView) v.findViewById(R.id.userName2);
            holder.pic = (ImageView) v.findViewById(R.id.userImg2);

            //Sending friend request
            acceptRequest = (Button)v.findViewById(R.id.acceptReqBtn) ;
            acceptRequest.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    new MakeFriends().execute("http://www.chatmaphannataer.com/index.html/enterDataToTblUserFriends.php?userName=" + actorList.get(position).getMember_name() + "&friendWith=" + getUserNamepref() + "", String.valueOf(position));
                    Toast.makeText(getApplicationContext(), "You R Friend with " + actorList.get(position).getMember_name() + "", Toast.LENGTH_SHORT).show();
    ...
    class MakeFriends extends AsyncTask<String, String, String> {
        InputStream is = null ;
        String result = "";
      String  checkPos = null ;
        ...
        protected void onPostExecute(String s) {
                ...
                new deletReqFromDB().execute("http://www.chatmaphannataer.com/index.html/deletRequestRow.php?userName=" + actorList.get(Integer.parseInt(checkPos)).getMember_name() + "&userSendR=" + getUserNamepref() + "");

            actorList.remove(Integer.parseInt(checkPos)); //or some other task
            notifyDataSetChanged();

        }
    }
    class deletReqFromDB extends AsyncTask<String, String, String> {
        InputStream is = null ;
        String result = "";
