...
import org.tatzpiteva.golan.Students_ChatMap_Project.chat.utils.DeviceUtils;
import org.tatzpiteva.golan.Students_ChatMap_Project.chat.utils.SharedPrefsHelper;
import org.tatzpiteva.golan.Students_ChatMap_Project.chat.utils.VersionUtils;
...
public class GooglePlayServicesHelper {
    ...
    private int getPlayServicesAvailabilityResultCode() {
        GoogleApiAvailability apiAvailability = GoogleApiAvailability.getInstance();
        return apiAvailability.isGooglePlayServicesAvailable(INaturalistApp.getInstance());
    }
    ...
    private void registerInGcmInBackground(String senderId) {
        new AsyncTask<String, Void, String>() {
            ...
            protected String doInBackground(String... params) {
                try {
                    InstanceID instanceID = InstanceID.getInstance(INaturalistApp.getInstance());
    ...
    public boolean checkPlayServices(Activity activity) {
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
                GooglePlayServicesUtil.getErrorDialog(resultCode, activity, PLAY_SERVICES_REQUEST_CODE)
                        .show();
            } else {
                Log.i(TAG, "This device is not supported.");
                activity.finish();
